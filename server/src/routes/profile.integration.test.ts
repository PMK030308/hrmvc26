...
before(() => {
  ...
  db.prepare(`INSERT INTO users
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?)`)
    .run(
      'profile-test-user', 'profile-test@technova.vn', 'profile-test-employee', 'unused-test-hash',
  ...
  db.prepare(`INSERT INTO users
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?)`)
    .run(
      'profile-other-user', 'profile-other@technova.vn', 'profile-other-employee', 'unused-test-hash',
      JSON.stringify(['Employee']), '[]', '[]',
    )
